...
@else
    <form action="{{ url('/penjualan_detail/' . $detail->detail_id . '/delete_ajax') }}" method="POST" id="formdelete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                dataPenjualanDetail.ajax.reload(); // Ganti sesuai nama DataTable kamu
                            } else {
                                Swal.fire({
                                    icon: 'error',
